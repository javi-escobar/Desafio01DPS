...
import { electrodomesticoData } from "../electrodomesticoData";


export const ElectrodomesticoList = ({
  allProducts,
  setAllProducts,
  total, 
  setTotal,
  ...
  return (
    <>
      <h2 className="titulo-seccion">Sección de Electrodomésticos</h2>
      <div className="container-items">
        {electrodomesticoData.map((item) => (
